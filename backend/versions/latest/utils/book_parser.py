...
# ── Book location ──────────────────────────────────────────────────────────────
# AutiStudy (backend) lives at  …/Downloads/AutiStudy/
# Books live at                 …/Downloads/AutiStudy-React/books_mds/
_BACKEND_DIR = Path(__file__).parent.parent          # …/Downloads/AutiStudy
BOOKS_DIR = _BACKEND_DIR.parent / "AutiStudy-React" / "books_mds"
