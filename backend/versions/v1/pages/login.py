...
def render_login():
    ...
    with col2:
        ...
        <div style="background: white; border-radius: 24px; padding: 2.5rem; box-shadow: 0 8px 30px rgba(0,0,0,0.1);">
            <h2 style="color: #1E3A5F; font-size: 2rem; font-weight: 800; margin-bottom: 0.5rem;">Login</h2>
            <p style="color: #64748B; margin-bottom: 1.5rem;">Welcome back! Please enter your details.</p>
        </div>
