...
def render_chat():
    ...
    with st.sidebar:
        ...
        <p style="color: #2563EB; margin: 0.5rem 0; font-size: 1.2rem;">Grade {grade} - {subject}</p>
        </div>
        """, unsafe_allow_html=True)
        ...
        <div style="background: #EFF6FF; border-radius: 16px; padding: 1.5rem; margin-top: 1rem;">
            <p style="color: #1E3A5F; font-weight: 700; margin: 0 0 0.75rem 0; font-size: 1.2rem;">Current Session</p>
            <p style="color: #64748B; font-size: 1.1rem; margin: 0.25rem 0;">Grade: {grade}</p>
            <p style="color: #64748B; font-size: 1.1rem; margin: 0.25rem 0;">Subject: {subject}</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div style="display: flex; align-items: center; margin-bottom: 1.5rem;">
        ...
        <div>
            <h2 style="color: #1E3A5F; font-weight: 800; margin: 0; font-size: 2.2rem;">AI Tutor</h2>
            <p style="color: #64748B; margin: 0.25rem 0 0 0; font-size: 1.3rem;">Grade {grade} - {subject}</p>
        </div>
    </div>
    """, unsafe_allow_html=True)
        ...
        if not st.session_state.chat_history:
            ...
            <div style="background: #F1F5F9; border-radius: 20px; padding: 2rem; margin-bottom: 1rem;">
                <div style="display: flex; align-items: flex-start;">
                    <div style="font-size: 2.5rem; margin-right: 1.5rem;">🤖</div>
                    <div>
                        <p style="color: #1E3A5F; font-weight: 700; margin: 0 0 0.75rem 0; font-size: 1.3rem;">AutiStudy AI Tutor</p>
                        <p style="color: #475569; margin: 0; font-size: 1.2rem; line-height: 1.6;">
                        ...
                        <p style="color: #475569; margin: 1rem 0 0 0; font-size: 1.2rem; line-height: 1.6;">
                        ...
                        <p style="color: #64748B; font-size: 1.1rem; margin: 1rem 0 0 0; font-style: italic;">
        ...
        for message in st.session_state.chat_history:
            if message["role"] == "user":
                ...
                <div style="background: linear-gradient(135deg, #2563EB 0%, #1D4ED8 100%); border-radius: 20px; 
                    padding: 1.25rem 1.75rem; margin: 0.75rem 0 0.75rem 20%; color: white;">
                    <p style="margin: 0; font-size: 1.2rem; line-height: 1.5;">{message["content"]}</p>
                </div>
                """, unsafe_allow_html=True)
            else:
                st.markdown(f"""
                <div style="background: #F1F5F9; border-radius: 20px; padding: 1.25rem 1.75rem; margin: 0.75rem 20% 0.75rem 0;">
                    <div style="display: flex; align-items: flex-start;">
                        <div style="font-size: 2rem; margin-right: 1rem;">🤖</div>
                        <div>
                            <p style="color: #475569; margin: 0; white-space: pre-wrap; font-size: 1.2rem; line-height: 1.6;">{message["content"]}</p>
                        </div>
                    </div>
                </div>
                """, unsafe_allow_html=True)
    ...
    st.markdown("<br>", unsafe_allow_html=True)
    st.markdown("""
    <p style="color: #64748B; font-size: 1.1rem; margin-bottom: 0.75rem; font-weight: 600;">Quick questions:</p>
    """, unsafe_allow_html=True)
