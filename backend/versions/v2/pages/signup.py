...
def render_signup():
        ...
        <div style="background: linear-gradient(135deg, #EFF6FF 0%, #DBEAFE 100%); border-radius: 24px; padding: 3rem; height: 100%; display: flex; align-items: center; justify-content: center;">
            <div style="text-align: center;">
                <img src="https://cdn-icons-png.flaticon.com/512/4712/4712109.png" 
                     style="width: 300px; height: auto;" alt="Student with Robot">
                <p style="color: #1E3A5F; font-size: 1.5rem; font-weight: 700; margin-top: 2rem;">
    ...
    with col2:
        ...
        <div style="background: white; border-radius: 24px; padding: 2.5rem; box-shadow: 0 8px 30px rgba(0,0,0,0.1);">
            <h2 style="color: #1E3A5F; font-size: 2.2rem; font-weight: 800; margin-bottom: 0.5rem;">Sign Up</h2>
            <p style="color: #64748B; margin-bottom: 1.5rem; font-size: 1.2rem;">Create your account to get started!</p>
        </div>
        """, unsafe_allow_html=True)
        
        with st.form("signup_form"):
            st.markdown('<p style="color: #1E3A5F; font-weight: 700; margin-bottom: 0.3rem; font-size: 1.1rem;">Name:</p>', unsafe_allow_html=True)
            name = st.text_input("Name", label_visibility="collapsed", placeholder="Enter your name")
            
            st.markdown('<p style="color: #1E3A5F; font-weight: 700; margin-bottom: 0.3rem; font-size: 1.1rem;">Email:</p>', unsafe_allow_html=True)
            email = st.text_input("Email", label_visibility="collapsed", placeholder="Enter your email")
            
            st.markdown('<p style="color: #1E3A5F; font-weight: 700; margin-bottom: 0.3rem; font-size: 1.1rem;">Password:</p>', unsafe_allow_html=True)
            ...
            with role_col:
                st.markdown('<p style="color: #1E3A5F; font-weight: 700; margin-bottom: 0.3rem; font-size: 1.1rem;">Role:</p>', unsafe_allow_html=True)
                role = st.selectbox("Role", ["Student", "Teacher", "Parent"], label_visibility="collapsed")
            
            with grade_col:
                st.markdown('<p style="color: #1E3A5F; font-weight: 700; margin-bottom: 0.3rem; font-size: 1.1rem;">Grade:</p>', unsafe_allow_html=True)
        ...
        st.markdown('<p style="text-align: center; color: #64748B; font-size: 1.1rem;">Already have an account?</p>', unsafe_allow_html=True)
